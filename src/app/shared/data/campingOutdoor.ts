...
export  const CampingOutdoor: Product[] = [
  ...
  },
  {
    ...
    description: [
      ...
      "Adjustable knob to adjust the flame as you see fit.",
      "Perfect for Camping and DIY.",
  ...
  },
  {
    ...
    description: [
      "- Colour: Grey/Silver",
      "- Material: Polyester",
      "- Cross pole construction providing quick set up, greater strength and water shedding ability",
      "- An inner tent with large mesh panels to keep the tent cool in hot climates",
      "- Silver coated UVTex 2000 fly reflects heat and protects you from the elements",
      "- Dry Floor heavy duty PE bucket floor for extra waterproofness at ground level",
      "- No-See-Um mesh in all windows keeps all those biting insects at bay so you'll sleep better",
      "- 100% Polyester inner tent that keeps you cool and dry in hot or humid conditions",
  ...
  },
  {
    ...
    description: [
      ...
      "- Colour: Red",
      "- Outer Material: 420D heavy duty Jacquard polyester",
      "- Inner Material: Welded food grade PEVA inner polypropylene webbing",
      "- Dimensions: 40cm x 17cm x 33cm",
      "- Weight: 0.8kg"
    ],
    price: 379,
    rating: 2
  ...
  },
  {
    ...
    description: [
      ...
      "- Fingertip control",
      "- The cylinder has a capped shroud for protection of valve with carry handle on shroud",
      "- The cylinder is suitable for cooker tops, lamps and heaters",
      "- Does not include a dust cap",
